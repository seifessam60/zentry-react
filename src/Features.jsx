...
const BentoTilt = ({ children, className = "" }) => {
  ...
  const handleMouseMove = (e) => {
    ...
    const tiltX = (relativeX - 0.5) * 6;
    const tiltY = (relativeY - 0.5) * -6;
  ...
  return (
    <section className="bg-black pb-52">
      <div className="container mx-auto px-3 md:px-10">
        ...
        <BentoTilt className="border border-hsla relative mb-7 h-96 w-full overflow-hidden rounded-md md:h-[65vh]">
          <BentoCard
        ...
        <div className="grid h-[135vh] grid-cols-2 grid-rows-3 gap-7">
          ...
          <BentoTilt>
            <div className="bento-tilt_2 h-full">
